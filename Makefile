...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/config.h.in $(top_srcdir)/build/mkinstalldirs \
	build/COPYING build/INSTALL build/ar-lib build/compile \
	build/config.guess build/config.sub build/depcomp \
	build/install-sh build/mdate-sh build/missing \
	build/mkinstalldirs build/py-compile build/texinfo.tex \
	build/ylwrap build/ltmain.sh $(top_srcdir)/build/ar-lib \
...
VERSION = 1.0
abs_builddir = /work/haopeng/trunk/user/cwmp
abs_srcdir = /work/haopeng/trunk/user/cwmp
