...
#include <cwmp_xmlet.h>
#include <cwmp_types.h>
#include <cwmp_util.h>
#include <cwmp_memory.h>
#include <cwmp_buffer.h>
#include <cwmp_event.h>
#include <cwmp_queue.h>
...
#define CWMP_RPC_GETPARAMETEATTIRBUTE               "cwmp:GetParameterAttributes"
#define CWMP_RPC_GETPARAMETEATTIRBUTERESPONSE       "cwmp:GetParameterAttributesResponse"
...
#define CWMP_RPC_SETPARAMETEATTIRBUTE               "cwmp:SetParameterAttributes"
#define CWMP_RPC_SETPARAMETEATTIRBUTERESPONSE       "cwmp:SetParameterAttributesResponse"
...
#define ModelNameModule                         "ModelName"
...
#define ModemFirmwareVersionModule  			"ModemFirmwareVersion"
#define EnabledOptionsModule   				    "EnabledOptions"
#define AdditionalHardwareVersionModule  		"AdditionalHardwareVersion"
#define AdditionalSoftwareVersionModule  		"AdditionalSoftwareVersion"
...
#define FirstUseDateModule  					"FirstUseDate"
#define VendorConfigFileNumberOfEntriesModule   "VendorConfigFileNumberOfEntries"

#define GatewayInfoModule                       "GatewayInfo"


/*******************************************************************
 *************** InternetGatewayDevice.ManagementServer.**********
 >This object contains parameters relating to the CPE's association 
 >with an ACS													   
*******************************************************************/
...
#define DownloadProgressURLModule 				"DownloadProgressURL"

/*******************wireless configuration*********************************
 **********InternetGatewayDevice.LANDevice.WLANConfiguration. *************                                                                                                              *
***************************************************************************/
#define   LANDeviceModule                           "LANDevice"
#define   WLANConfigurationModule              "WLANConfiguration"
#define   WlSSIDModule                  "SSID"
#define   WlChannelModule                   "Channel"
#define   MACAddressControlEnabledModule      "MACAddressControlEnabled"
#define   WlEnableModule                    "Enable"
#define   WlBssidModule                 "BSSID"
#define   WPAEncryptionModule           "WPAEncryptionModes"
#define   WlKeyPassphraseModule         "KeyPassphrase"
#define   WlStandardModule              "Standard"
#define   WlDeviceOperationModeModule   "DeviceOperationMode"
#define   WlBandModule                  "WirelessBand"
#define   WlStatusModule                    "Status"
#define   WlMACModule                   "PeerBSSID"
...
#define LANModule                     "Lan"
#define IPAddressModule 				"IPAddress"
...
struct cwmp_st
{
    ...
    int    cpe_auth;
    int    acs_auth;// not to use now
    int    cpe_periodic;
    int    cpe_periodic_time;
    char * acs_url;
    char * cpe_mf;
    char * cpe_oui;
    char * cpe_sn;
...
xmldoc_t *  cwmp_create_getparametervalues_response_message(env_cwmp * env ,
        header_t * header,
        parameter_list_t * pl);

xmldoc_t *  cwmp_create_setparametervalues_response_message(env_cwmp * env ,
        header_t * header,
        unsigned int status);

xmldoc_t *  cwmp_create_getrpcmethods_response_message(env_cwmp * env ,
        header_t * header,
        char ** methods,
        unsigned int count);

xmldoc_t *  cwmp_create_reboot_response_message(env_cwmp * env ,
        header_t * header);
