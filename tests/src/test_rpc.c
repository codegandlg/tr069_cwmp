...
static void test_cwmp_session_create_getparameternames(abts_case *tc, void *data)
{
    ...
    xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:cwmp=\""
        "urn:dslforum-org:cwmp-1-0\" xmlns=\"urn:dslforum-org:cwmp-1-0\">"
        "<SOAP-ENV:Header>"
        "<cwmp:ID>129479899093788892</cwmp:ID>"
        "<cwmp:NoMoreRequests>0</cwmp:NoMoreRequests>"
        "</SOAP-ENV:Header>"
        "<SOAP-ENV:Body>"
        "<cwmp:GetParameterNames>"
        "<ParameterPath>InternetGatewayDevice.</ParameterPath><NextLevel>1</NextLevel>"
        "</cwmp:GetParameterNames>"
        "</SOAP-ENV:Body>"
        "</SOAP-ENV:Envelope>"
        ;
    ...
    cwmp_write_xmldoc_to_chunk(newdoc, session->writers,  pool);
